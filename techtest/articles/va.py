...
class ArticleListViewTestCase(TestCase):
    def setUp(self):
        ...
        self.article_2.regions.set([self.region_1, self.region_2, self.author_1, self.author_2])
    ...
    def test_creates_new_article_with_regions(self):
        payload = {
            ...
            "authors": [
                ...
                {"first_name": "AU", "last_name": "Austria"},
            ],
        }
        ...
        authors = Author.objects.filter(articles__id=article.id)
        ...
        self.assertDictEqual(
            {
                ...
                "authors": [
                    ...
                    {"id": authors.all()[1].id, "first_name": "AU", "last_name": "Austria"},
                ],
            },
            response.json(),
        )
